...
<%@ page import= "pe.edu.cibertec.model.Usuario" %>
...
<%-- 							<s:else>Hola <s:property value="#variable" /></s:else> --%>
								<strong class="title-1"><s:text name="Idioma.Transporte"></s:text></strong>
								<strong class="title-2"><s:text name="Idioma.deMercanciasEspeciales"></s:text></strong>
								<p class="img-indent-bot"><s:text name="Idioma.EstesitiohasidocreadopararegistrarsolicitudesdeAutorizaciondeTransportedeMercanciasEspeciales"></s:text></p>
								<div class="aligncenter">
									<a class="button" href="leerMas.jsp"><s:text name="Idioma.LeerMas"></s:text></a>
								</div>
							</div>
						</div>
					</div>
