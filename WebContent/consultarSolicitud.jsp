...
<!--==============================content=================================-->				
	<div class="wrapper">
		<div class="extra-wrap">
			...
			<s:url action="cconsultarTodos"	var="vconsultarTodos"/> 
			<ul>
				<li><s:a href="%{vconsultarTodos}"><s:text name="Idioma.ConsultarTodos"/></s:a></li>
			</ul>
			
			<s:url action="cconsultarxNroSolicitud"	var="vconsultarxNroSolicitud"/> 
			<ul>
				<li><s:a href="%{vconsultarxNroSolicitud}"><s:text name="Idioma.ConsultarporNumero"/></s:a></li>
			</ul>
			
			<s:url action="cconsultarxDni"	var="vconsultarxDni"/> 
			<ul>
				<li><s:a href="%{vconsultarxDni}"><s:text name="Idioma.ConsultarporDNI" /></s:a></li>
			</ul>
			
			<s:url action="cconsultarxEstado"	var="vconsultarxEstado"/> 
			<ul>
				<li><s:a href="%{vconsultarxEstado}"><s:text name="Idioma.ConsultarporEstado"/></s:a></li>
			</ul>	
